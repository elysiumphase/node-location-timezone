...
If you'd like to contribute to node-location-timezone,
see our [Contributing Guidelines](CONTRIBUTING.md).

If you've found a bug in a [supported version](#supported-versions)
of node-location-timezone, please report it with the
[issue tracker](https://github.com/elysiumphase/node-location-timezone/issues).
...
version of node-location-timezone is in use.
