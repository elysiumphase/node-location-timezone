---
name: Bug report
about: Create a report to help us improve node-location-timezone
title: ''
labels: ''
assignees: ''
...
* [ ] I have searched the [issue tracker](https://github.com/elysiumphase/node-location-timezone/issues) for an issue that matches the one I want to file, without success.
...
* **Node Version**:
* **NPM Version**:
* **node-location-timezone Version**:
* **Last Known Working node-location-timezone Version**:
